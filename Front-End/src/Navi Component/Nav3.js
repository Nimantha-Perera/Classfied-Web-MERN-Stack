...
const NavbarComponent = () => {
  ...
  const [isMyAccountClicked, setMyAccountClicked] = useState(false); // Add state variable for button click
      ...
      <Navbar className="navbar navbar-expand-lg navbar-light bg-primary">
        <div className="container col-md-7">
          ...
          <div className="ml-auto btns">
            <button
              className={`btn  creat_acc activeb`}
              id="create_acc_btn"
              


            //   styles on my account button
            style={{backgroundColor:"rgba(206, 206, 206, 0.39)"}}
            >
